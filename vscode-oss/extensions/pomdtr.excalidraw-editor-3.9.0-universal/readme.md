...
![demo](https://github.com/excalidraw/excalidraw-vscode/raw/HEAD/medias/screenshot.png)
...
![Image can be edited directly](https://github.com/excalidraw/excalidraw-vscode/raw/HEAD/medias/edit_image.gif)
...
![theme switching](https://github.com/excalidraw/excalidraw-vscode/raw/HEAD/medias/change-theme.gif)
...
![Public libraries can be imported from the browser](https://github.com/excalidraw/excalidraw-vscode/raw/HEAD/medias/import-library.gif)

### View Drawing Source

You can switch between the Excalidraw editor and the source (text or image) using the editor toolbar.

![Use the dedicated toolbar button to view the diagram source](https://github.com/excalidraw/excalidraw-vscode/raw/HEAD/medias/view_source.gif)
